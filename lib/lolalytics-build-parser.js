 ...
 *
 * The parser keeps exact rune-page candidates, grouped slot options, ordered
 * completed-item options, and only completed boots so later aggregation can
 * combine multiple enemy matchups without re-reading the raw Qwik payload.
 */
