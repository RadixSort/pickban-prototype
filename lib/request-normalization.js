...
function normalizeBuildSuggestionRequest(
  ...
  const requireCompleteMatchups = requestBody.requireCompleteMatchups;
  if (
    requireCompleteMatchups != null &&
    typeof requireCompleteMatchups !== "boolean"
  ) {
    throw createError(
      400,
      'Request field "requireCompleteMatchups" must be a boolean.',
    );
  }
  ...
  return {
    ...
    enemies,
    rankFilter,
    ...(requireCompleteMatchups === true ? { requireCompleteMatchups: true } : {}),
  };
}
