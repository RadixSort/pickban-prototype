 ...
 * an assigned role and exactly five enemy champions so build recommendations
 * are always aggregated from a complete opposing composition.
 */
function normalizeBuildSuggestionRequest(
  ...
  if (enemies.length !== 5) {
    throw createError(400, 'Request field "enemies" must contain exactly 5 enemy champions.');
  }
