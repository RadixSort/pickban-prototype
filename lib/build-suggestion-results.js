 ...
 *
 * The output keeps both overview-level slot distributions and exact page/boots
 * highlights so the UI can render a compact answer without knowing about the
 * raw Lolalytics payload structure.
 */
