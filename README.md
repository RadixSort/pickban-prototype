...
- The app shows every suggested result with projected win rate at or above `50%`. If that produces fewer than `10` rows, it fills the rest with the best remaining projected win rate options.
